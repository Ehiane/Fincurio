...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-full lg:w-72 flex-shrink-0 bg-background-light border-b lg:border-b-0 lg:border-r border-stone-200 dark:border-stone-800/50 p-6 lg:p-8 flex flex-col justify-between z-20">
      <div>
