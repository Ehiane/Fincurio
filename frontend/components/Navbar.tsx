...
const Navbar: React.FC = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 lg:px-20 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-[#38292b]/20">
      ...
      <Link 
        to="/signin"
        className="group flex items-center justify-center rounded-full h-10 px-6 bg-transparent border border-stone-300 dark:border-[#533c40] text-sm font-bold text-stone-800 dark:text-white hover:border-primary hover:text-primary transition-all"
      >
        Sign In
      </Link>
    </header>
